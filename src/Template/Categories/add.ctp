        ...
        <div class="col-md-12">
            ...
            <fieldset class="form-group">
                <label class="c-input c-radio">
                    <input id="radio1" name="status" value="public" type="radio" checked>
                    <span class="c-indicator"></span>
                    <?= __('Everyone can access this category'); ?>
                </label>
                <label class="c-input c-radio">
                    <input id="radio2" name="status" value="auth" type="radio">
                    <span class="c-indicator"></span>
                    <?= __('Only authenticated users can access this category'); ?>
                </label>
                <label class="c-input c-radio">
                    <input id="radio2" name="status" value="admin" type="radio">
                    <span class="c-indicator"></span>
            ...
            <?= $this->Form->submit(__('Add category'), ['class' => 'btn btn-primary-outline btn-lg'], ['placeholder' => __('Describe your category')]); ?>
            <?= $this->Form->end(); ?>
        </div>
    </div>
</div>